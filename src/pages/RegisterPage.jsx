...
import { User, Lock, Mail, CheckCircle, Phone, CreditCard } from 'lucide-react';
            ...
            <div className="login-form-container">
                <div className="login-form-box" style={{ maxWidth: '450px' }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ marginBottom: '1rem' }}>
                            <label className="form-label" style={{ display: 'block', marginBottom: '0.5rem', color: 'var(--color-text-secondary)', fontSize: '0.9rem' }}>Cédula de Identidad *</label>
                            <div className="input-group">
                        ...
                        <div style={{ marginBottom: '1rem' }}>
                            <label className="form-label" style={{ display: 'block', marginBottom: '0.5rem', color: 'var(--color-text-secondary)', fontSize: '0.9rem' }}>Teléfono *</label>
                            <div className="input-group">
